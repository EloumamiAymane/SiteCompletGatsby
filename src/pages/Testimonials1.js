...
<section >
    ...
    <div className="elementor-container elementor-column-gap-default">
        <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-ba5fee4"
            data-id="ba5fee4" data-element_type="column">
            <div className="elementor-widget-wrap elementor-element-populated">
                <div className="elementor-element elementor-element-fbbf2d0 elementor-widget elementor-widget-naxly_tk_testimonials"
                    data-id="fbbf2d0" data-element_type="widget" data-widget_type="naxly_tk_testimonials.default">
                    <div className="elementor-widget-container">

                        <section className="client-testi-section">
                                    ...
                                    <div className="col-lg-8">
                                        ...
                                        <div className="bx-wrapper" style={{maxWidth:"100%"}}>
                                            <div className="bx-viewport"
                                                ...
                                                <div className="bxslider testimonial_new_bx"
                                            ...
                                            <div className="bx-controls bx-has-controls-direction">
                                                <div className="bx-controls-direction"><a className="bx-prev" ><i
                                                            className="flaticon-next" onClick={next}></i></a><a className="bx-next" ><i
                                                            className="flaticon-next" onClick={Previous}></i></a></div>
                                            </div>
                                        </div>

                                        <div className="bx-pager">
                                            <a data-slide-index="0" href="" className="wow flipInY animated active"
                                                ...
                                                <span className=" bx_pagination"><img loading="lazy" decoding="async"
                                            ...
                                            <a data-slide-index="1" href="" className="wow flipInY animated"
                                                data-wow-delay="100ms" data-wow-duration="2500ms"
                                                style={{visibility:'visible',animationDuration:'2500ms',animationDelay:'100ms',animationName:'flipInY'}}>
                                                <span className=" bx_pagination"><img loading="lazy" decoding="async"
                                                        width="160" height="161"
                                            ...
                                            <a data-slide-index="2" href="" className="wow flipInY animated"
                                                data-wow-delay="100ms" data-wow-duration="2500ms"
                                                style={{visibility:'visible',animationDuration:'2500ms',animationDelay:'100ms',animationName:'flipInY'}}>
                                                <span className=" bx_pagination"><img loading="lazy" decoding="async"
                                                        width="160" height="161"
                                            ...
                                            <a data-slide-index="3" href="" className="wow flipInY animated"
                                                data-wow-delay="100ms" data-wow-duration="2500ms"
                                                style={{visibility:'visible',animationDuration:'2500ms',animationDelay:'100ms',animationName:'flipInY'}}>
                                                <span className=" bx_pagination"><img loading="lazy" decoding="async"
                                                        width="160" height="161"
