                                                    ...
                                                    <div class="content-box">
                                                        ...
                                                        <div class="inner-box">
                                                            <div class="progress-box">
                                                                ...
                                                                <div class="bar">
                                                                    <div class="bar-inner count-bar" data-percent="62% " style={{width:'62%'}}><div class="count-text" >62%</div></div>
                                                                </div>
                                                            </div>
                                                            <div class="progress-box">
                                                                <h5>Big Data &amp; BI</h5>
                                                                ...
                                                                <div class="bar">
                                                                    <div class="bar-inner count-bar" data-percent="89%" style={{width:'89%'}}><div class="count-text">89%</div></div>
                                                                </div>
                                                            </div>
                                                            <div class="progress-box">
                                                                ...
                                                                <div class="bar">
                                                                    <div class="bar-inner count-bar" data-percent="75%" style={{width:'75%'}}><div class="count-text">75%</div></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
