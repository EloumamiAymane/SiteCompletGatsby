            ...
            <div class="left-column pull-left clearfix">
                <div class="logo-box pull-left">
                    <figure class="logo"><a href="https://naxly.wpcomstaging.com/" title="Titre du site"><img
                                src="https://naxly.wpcomstaging.com/wp-content/uploads/2020/04/logo_MI.png" alt="logo"
                                    ...
                                    <ul role="menu" class="submenu">
                                        ...
                                        <li id="menu-item-117"
                                            ...
                                            <a title="Artificial intelligence"
                                                ...
                                                intelligence</a></li>
                                        <li id="menu-item-209"
                                            class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-205 current_page_item menu-item-209 active">
                                            ...
                                            <ul role="menu" class="submenu">
                                                ...
                                                <li id="menu-item-472"
                                                    ...
                                                    <a title="Header Style Two"
                                                        ...
                                                        Style Two</a></li>
                                                <li id="menu-item-471"
                                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-205 current_page_item menu-item-471 active">
